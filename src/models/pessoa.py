...
def __str__(self) -> str:
    ...
    """   
    return f"{self.nome} tem {self.idade} anos de idade da nacionalidade {self.nacionalidade}"

def fazer_aniversario(self):
    """
    Método utilizado para incrementar a variável da idadde em 1, será utilizado quando a pessoa fazer aniversário, 
...
# chamando um método 'fazer_aniversário' do objeto patrick (da classe Pessoa)
